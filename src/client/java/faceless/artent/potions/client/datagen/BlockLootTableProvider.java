...
public class BlockLootTableProvider extends FabricBlockLootTableProvider {
  ...
  public void generate() {
    ...
    for (int i = 0; i < ModBlocks.MUSHROOM_INFO.length; i++) {
      addDrop(ModBlocks.MUSHROOM_INFO[i].mycelium());
    }
    ...
    addDrop(
        ModBlocks.CRIMSONWOOD_LEAVES.block(), this
            .leavesDrops(
            ...
            .pool(LootPool
                      ...
                      .with(((LeafEntry.Builder<?>) this.addSurvivesExplosionCondition(
                          ModBlocks.CRIMSONWOOD_LEAVES.block(),
                          ItemEntry.builder(ModItems.CRIMSON_LEAF))).conditionally(
                      ...
                      .with(((LeafEntry.Builder<?>) this.addSurvivesExplosionCondition(
                          ...
                          TableBonusLootCondition.builder(
                              ...
                              0.0125F)))));
    this.addDrop(
        ModBlocks.ICE_CRYSTAL_CLUSTER.block(), (Block block) -> this.dropsWithSilkTouch(
            block,
            (ItemEntry
