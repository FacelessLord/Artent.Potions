...
public class Shelf extends BlockWithEntity implements INamed {
  ...
  protected ActionResult onUseWithItem(
    ...
    var blockEntityOptional = world.getBlockEntity(pos, ModBlockEntities.Shelf);
  ...
  protected static final VoxelShape SHAPE_NORTH = Block.createCuboidShape(0, 0, 10, 16, 16, 16);
  protected static final VoxelShape SHAPE_SOUTH = Block.createCuboidShape(0, 0, 0, 16, 16, 6);
  protected static final VoxelShape SHAPE_WEST = Block.createCuboidShape(10, 0, 0, 16, 16, 16);
  protected static final VoxelShape SHAPE_EAST = Block.createCuboidShape(0, 0, 0, 6, 16, 16);
