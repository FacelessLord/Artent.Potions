...
public class BrewingCauldron extends BlockWithEntity implements INamed {
    ...
    protected ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, BlockHitResult hit) {
        ...
        var stack = player.getEquippedStack(player.getActiveHand() == Hand.MAIN_HAND ? EquipmentSlot.MAINHAND : EquipmentSlot.OFFHAND);
    ...
    protected static final VoxelShape SHAPE = VoxelShapes.union(Block.createCuboidShape(3, 0, 3, 5, 3, 5), Block.createCuboidShape(3, 0, 11, 5, 3, 13), Block.createCuboidShape(11, 0, 11, 13, 3, 13), Block.createCuboidShape(11, 0, 3, 13, 3, 5), Block.createCuboidShape(2, 3, 2, 14, 4, 14), Block.createCuboidShape(14, 4, 2, 15, 13, 14), Block.createCuboidShape(2, 4, 14, 14, 13, 15), Block.createCuboidShape(1, 4, 2, 2, 13, 14), Block.createCuboidShape(2, 4, 1, 14, 13, 2));
    protected static final VoxelShape SHAPE_WITH_COAL = VoxelShapes.union(Block.createCuboidShape(3, 0, 3, 5, 3, 5), Block.createCuboidShape(3, 0, 11, 5, 3, 13), Block.createCuboidShape(11, 0, 11, 13, 3, 13), Block.createCuboidShape(11, 0, 3, 13, 3, 5), Block.createCuboidShape(2, 3, 2, 14, 4, 14), Block.createCuboidShape(14, 4, 2, 15, 13, 14), Block.createCuboidShape(2, 4, 14, 14, 13, 15), Block.createCuboidShape(1, 4, 2, 2, 13, 14), Block.createCuboidShape(2, 4, 1, 14, 13, 2), Block.createCuboidShape(1, 0, 1, 15, 2, 15));
