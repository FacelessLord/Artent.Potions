...
public final class ModBlocks {
  public static RegisteredBlock<?> LOCATOR;
  ...
  public void register() {
    ...
    BREWING_CAULDRON = register(
        ...
        Block.Settings
            ...
            .nonOpaque()
            .ticksRandomly()
            .luminance(state -> state.get(faceless.artent.potions.block.BrewingCauldron.IS_BURNING)
                ? 15
                : 0)
            .strength(2f),
        ModItemGroups.BASE
    ...
    for (int type = 0; type < BERRY_BUSH.length; type++) {
      ...
      BERRY_BUSH[type] = register(
          ...
          Block.Settings.copy(Blocks.ACACIA_LEAVES)
    ...
    CRIMSONWOOD_PLANKS_STAIRS = register(
        ...
        (AbstractBlock.Settings settings) -> new StairsBlock(
            CRIMSONWOOD_PLANKS.block()
                              .getDefaultState(),
            settings
        ),
        Block.Settings
    ...
    FROST_PUMPKIN_CARVED = register(
        ...
        Block.Settings.copy(Blocks.CARVED_PUMPKIN)
    ...
    ICE_CRYSTAL_BLOCK = register(
        "ice_crystal_block",
        Block::new,
        Block.Settings.copy(Blocks.AMETHYST_BLOCK)
                      .mapColor(MapColor.CYAN)
                      .nonOpaque(),
        ModItemGroups.BASE
    );
    ...
    ICE_CRYSTAL_BUD_SMALL = register(
        ...
        Block.Settings.copy(Blocks.SMALL_AMETHYST_BUD)
                      .mapColor(MapColor.CYAN)
                      .nonOpaque(),
        ModItemGroups.BASE
    );
    ...
    ICE_CRYSTAL_BUD_MEDIUM = register(
        ...
        Block.Settings.copy(Blocks.MEDIUM_AMETHYST_BUD)
                      .mapColor(MapColor.CYAN)
                      .ticksRandomly()
                      .nonOpaque(),
        ModItemGroups.BASE
    ...
    ICE_CRYSTAL_BUD_LARGE = register(
        ...
        Block.Settings.copy(Blocks.LARGE_AMETHYST_BUD)
                      .mapColor(MapColor.CYAN)
                      .ticksRandomly()
                      .nonOpaque(),
        ModItemGroups.BASE
    ...
    ICE_CRYSTAL_CLUSTER = register(
        ...
        Block.Settings.copy(Blocks.AMETHYST_CLUSTER)
                      .mapColor(MapColor.CYAN)
                      .ticksRandomly()
                      .nonOpaque(),
        ModItemGroups.BASE
    ...
    var BrownMushroomMycelium = register(
        ...
        Block.Settings.copy(Blocks.MYCELIUM)
                      .ticksRandomly()
                      .mapColor(MapColor.BROWN),
        ModItemGroups.BASE
    );
    ...
    var growingShroomMushroom = registerBlock(
        ...
        Block.Settings.copy(Blocks.RED_MUSHROOM)
                      .ticksRandomly()
                      .mapColor(MapColor.LAPIS_BLUE)
    );
  ...
  public static RegisteredBlock<Block> register(
    ...
    var itemKey = keyOf(key);
    var blockItem = customBlockItem.apply(
        block,
        new Item.Settings().registryKey(itemKey)
    );
    Registry.register(Registries.ITEM, itemKey, blockItem);
